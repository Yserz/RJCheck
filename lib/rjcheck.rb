...
require_relative 'rubytest/meta_model/java/class'
require_relative 'rubytest/meta_model/java/interface'
require_relative 'rubytest/meta_model/java/method'

require_relative 'rubytest/crawler/crawler'
require_relative 'rubytest/crawler/java/java_crawler'
require_relative 'rubytest/mapper/java/java_mapper'
